//Rematrícula Escolar - código para verificar se uma pessoa pode realizar a rematrícula
...
if(idadeDoAluno < 18){
    console.log((possuiResponsavel === true? "Rematrícula realizada com sucesso" : "Não é possível fazer a rematrícula"  ));
}else{
